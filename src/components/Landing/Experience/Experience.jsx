...
const Experience = (props) => {
    const experience = require('./data/experience2.json')
    const [selectedTab, setSelectedTab] = useState(0);
    // const [selectedSubTab, setSelectedSubTab] = useState(0);
    const [selectedInfo, setSelectedInfo] = useState(experience.tabs[selectedTab]);
    ...
    useEffect(() => { 
        ...
        setSelectedInfo(experience.tabs[selectedTab]);  
